...
public final class ActivityMainBinding implements ViewBinding {
  ...
  private ActivityMainBinding(@NonNull ConstraintLayout rootView, @NonNull Button button0,
      ...
      @NonNull Button button7, @NonNull Button button8, @NonNull GridLayout gridLayout,
      @NonNull Button playAgainButton, @NonNull TextView statusTextView) {
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMainBinding((ConstraintLayout) rootView, button0, button1, button2,
          button3, button4, button5, button6, button7, button8, gridLayout, playAgainButton,
          statusTextView);
    }
